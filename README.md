...
## Idea 1 — Business Store Profile
Store profiles now support optional category, phone, location, address, opening hours, delivery/collection, logo, banner, and a longer business description. These are store/business fields and do not change normal listing seller fields.

Run `store_sql_v20.sql` in Supabase SQL Editor to add the new Store columns and keep the Store delete policy.
