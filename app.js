...
async function handleAuthChange() {
  ...
  if (user) {
    ...
    authArea.innerHTML = `<div class="auth-pill-group"><span class="auth-pill">Welcome, ${escapeHtml(displayName)}</span><button id="btn-my-listings" class="auth-pill auth-my-listings" type="button">My Listings</button><button id="btn-account" class="auth-pill auth-account" type="button">Account</button><button id="btn-logout" class="auth-pill auth-logout" type="button">Logout</button></div>`
...
function renderFilteredListings() {
  ...
  filtered.forEach((item) => renderListing(item, listingsContainer))
