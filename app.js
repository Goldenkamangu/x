...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Hide as soon as the first listings fetch settles (success or failure),
  // instead of a blind fixed delay — with a safety cap so it never hangs.
  ...
  setTimeout(hideLoadingScreen, 4000) // safety cap in case something hangs
